...
class SightAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SightAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.card_layout, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: SightAdapter.ViewHolder, position: Int) {
